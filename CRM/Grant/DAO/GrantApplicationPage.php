 ...
 * (GenCodeChecksum:3ce76fe2457afbc3643392a1fe621f9e)
 */
...
class CRM_Grant_DAO_GrantApplicationPage extends CRM_Core_DAO {
  ...
  /**
   * This text field is shown when is_for_organization is checked. For example - I am submitting grant application on behalf of an organization.
   *
   * @var text
   */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'is_for_organization' => [
          ...
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'description' => CRM_Grantapplications_ExtensionUtil::ts('if true, signup is done on behalf of an organization'),
          'where' => 'civicrm_grant_app_page.is_for_organization',
          'default' => '0',
          'table_name' => 'civicrm_grant_app_page',
          'entity' => 'GrantApplicationPage',
          'bao' => 'CRM_Grant_DAO_GrantApplicationPage',
        ...
        'for_organization' => [
          ...
          'type' => CRM_Utils_Type::T_TEXT,
          'title' => CRM_Grantapplications_ExtensionUtil::ts('For Organization'),
          'description' => CRM_Grantapplications_ExtensionUtil::ts('This text field is shown when is_for_organization is checked. For example - I am submitting grant application on behalf of an organization.'),
          'rows' => 6,
          'cols' => 50,
          'where' => 'civicrm_grant_app_page.for_organization',
          'table_name' => 'civicrm_grant_app_page',
          'entity' => 'GrantApplicationPage',
          'bao' => 'CRM_Grant_DAO_GrantApplicationPage',
          'localizable' => 0,
