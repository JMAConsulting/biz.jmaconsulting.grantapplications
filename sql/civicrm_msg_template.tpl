...
{foreach from=$ovs key=vName item=title name=for_values}
      {fetch assign=subject file="`$config->extensionsDir`biz.jmaconsulting.grantprofiles/sql/message_templates/`$vName`_subject.tpl"}
      {fetch assign=text    file="`$config->extensionsDir`biz.jmaconsulting.grantprofiles/sql/message_templates/`$vName`_text.tpl"}
      {fetch assign=html    file="`$config->extensionsDir`biz.jmaconsulting.grantprofiles/sql/message_templates/`$vName`_html.tpl"}
