      ...
      <div class="civicrm-modal-content">
        ...
        <span class="civicrm-modal-selector">
          <select id="add_civicomponent_id">
            ...
            <?php } ?>
            <?php if ( !empty( $grant_app_pages ) ) { ?>
            <option value="grant"><?php _e( 'Grant Application Page', 'civicrm' ); ?></option>
            <?php } ?>
        ...
        <span id="grant_app-section" style="display: none;">
          <?php if ( !empty( $grant_app_pages ) ) { ?>
          <select id="add_grantapppage_id">
          <?php foreach ($grant_app_pages AS $key => $value) { ?>
            <option value="<?php echo absint($key) ?>"><?php echo esc_html($value) ?></option>
          <?php } ?>
          </select>
          <?php } ?>
