  ...
  $('#crm-wp-insert-shortcode').on('click', function () {
    ...
    switch (component) {
      case 'contribution':
        ...
        break;
      case 'grant':
        shortcode += ' id="' + $("#add_grantapppage_id").val() + '"';
        shortcode += ' mode="' + $("input[name='component_mode']:checked").val() + '"';
        break;
      case 'event':
  ...
  $('#add_civicomponent_id').on('change', function () {
    switch ($(this).val()) {
      case 'contribution':
        ...
        $('#grant_app-section, #component-section').hide();
        ...
        break;
      case 'grant':
        $('#grant_app-section, #component-section').show();
      ...
      case 'profile':
        ...
        break;
      case 'user-dashboard':
        $('#contribution-section, #grant_app-section, #event-section, #component-section, #action-section-event').hide();
        $('#profile-section, #profile-mode-section').hide();
        $('#petition-section').hide();
        $('.hijack').show();
        break;
